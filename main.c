...
/*
  Модуль управления клиентским асинхронным соединением:
   1. Обработка onDisconnect - если вдруг сервер отвалился - нужно уметь к нему законнекчиваться?
   2. Обработка onReplay - при получении ответа от сервера - что делать???


  Важный вопрос - что делать - если потеряно соединение с сервером. В каком состоянии находились мои милые соединения???
  Как это вообще можно понять???

  Еще одна тема - статистика. Как можно определить сколько проходит пакетов (в секунду?) - мы можем говорить о том,
  сколько пакетов было в прошлую секунду? - да, она закончилась. След - нужно обращаться к каунтеру отсылки???
